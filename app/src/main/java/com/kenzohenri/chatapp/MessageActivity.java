...
import com.kenzohenri.chatapp.Fragments.APIService;
...
import com.kenzohenri.chatapp.Notifications.Client;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(fuser.getEmail().equals("admin@chatapp.com")){
            ...
            toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(MessageActivity.this,Home.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                }
            });
        }
