...
public class Visitor extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showMessage();
                startActivity(new Intent(Visitor.this,StartActivity.class));
            }
        });
    ...
    private void showMessage() {
        Toast.makeText(getApplicationContext(), "Please log in or register first", Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_exit) {
            startActivity(new Intent(Visitor.this,StartActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            return true;
        }
    ...
    public void updateNavHeader(){
        ...
        navUsername.setText("Visitor");
        navUserMail.setText("example@youremail.com");
        //Load userPhoto
